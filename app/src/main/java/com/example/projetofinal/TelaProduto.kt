...
fun Produtos() {
    ...
    //val estadoCampoDeTextoFoto = remember { mutableStateOf(TextFieldValue()) }
    val activity = (LocalContext.current as? Activity)
    Column(
        Modifier.padding(40.dp)
    ) {
        Text(text="Tela de Produto", textAlign = TextAlign.Center,modifier = Modifier.fillMaxWidth())
